...
export default function AdminDashboard() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-2">
        <div className="h-11 w-11 rounded-xl bg-gradient-to-br from-brand-500 to-indigo-600 grid place-items-center text-white font-extrabold shadow-md">JS</div>
        <div>
  ...
  <tr key={u.id} className="border-t border-slate-100 align-middle">
    {/* i starts at 0, so i + 1 gives you 1, 2, 3... consecutive rows */}
  ...
  <tr key={j.id} className="border-t border-slate-100">
    {/* Use i + 1 here (index starts at 0, so adding 1 makes it start at 1) */}
    <td className="p-3 text-slate-500 font-medium">{i + 1}</td>
