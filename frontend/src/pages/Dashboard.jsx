...
export default function Dashboard() {
  ...
  const tiles = isAdmin ? [
    ...
    { to: '/manage-jobs', t: 'Manage Jobs',  d: 'Delete and review applicants.' },
  ]

  return (
    <PageWrap>
      <div className="flex items-center gap-3">
        {/* <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-brand-500 to-indigo-600 grid place-items-center text-white font-extrabold shadow-md">JS</div> */}
        <div>
